                                ...
                                {currentItems.map((ticket, index) => (
                                    <tr key={ticket.id}>
                                        ...
                                        <td className="px-6 py-4">
                                            ...
                                            <Link to={`/conductor/tickets/${ticket.id}/edit`} className="text-blue-600 hover:text-blue-900 ml-10">
                                                Edit
                                            </Link>
                                        </td>
                                    </tr>
...
export default withAuthorization(TicketListConductor, ["Conductor"]);