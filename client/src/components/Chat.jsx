    ...
    return (
        <div className="flex flex-col justify-center items-center mt-10 px-4 selection:bg-orange-400 selection:text-white">
            <div className="max-w-sm lg:max-w-full lg:flex justify-center items-center space-x-2 overflow-hidden shadow-2xl px-6 py-4 flex rounded-lg">
                <div>
                    <h2 className="text-2xl text-orange-400 font-extralight">Planifikoni udhetimin tuaj permes intelegjences artificiale</h2>
                    <form onSubmit={handleSubmit} className="mt-4">
                        <input
                            type="text"
                            value={question}
                            onChange={handleInputChange}
                            placeholder="Shkruani pyetjen tuaj ketu..."
                    ...
                    {answer && (
                        <div className="mt-4">
                            <h3 className="text-lg font-semibold">Pergjgja:</h3>
